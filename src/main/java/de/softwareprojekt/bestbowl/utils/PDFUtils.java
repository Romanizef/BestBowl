...
public class PDFUtils {
    ...
    private File testFolder = new File(Utils.getWorkingDirPath() + File.separator + "rechnung");
    private String filePath = testFolder.getAbsolutePath() + File.separator + "rechnungs.pdf";
     ...
     * @throws IOException
     */
    public PDDocument createInvoicePdf(BowlingAlleyBooking booking) throws IOException {
        // get data from DB
        Optional<BookingHistory> bookingHistory = Repos.getBookingHistoryRepository()
                .findByClientEqualsAndBowlingAlleyEqualsAndTimeStampEquals(booking.getClient(),
        ...
        List<FoodBooking> foodBookingList = Repos.getFoodBookingRepository()
                .findAllByClientEqualsAndBowlingAlleyEqualsAndTimeStampEquals(booking.getClient(),
                        booking.getBowlingAlley(), booking.getStartTime());
        List<BowlingShoeBooking> shoekBookingList = Repos.getBowlingShoeBookingRepository()
                .findAllByClientEqualsAndBowlingAlleyEqualsAndTimeStampEquals(booking.getClient(),
                        booking.getBowlingAlley(), booking.getStartTime());
