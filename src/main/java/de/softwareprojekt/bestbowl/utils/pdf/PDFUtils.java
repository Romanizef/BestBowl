...
public class PDFUtils {
    ...
    private static Table createSimpleExampleTable(List<InvoiceLine> invoiceLineList, double discount) {
        ...
        for (int i = 0; i < invoiceLineList.size(); i++) {
            ...
            tableBuilder.addRow(Row.builder()
                    .add(TextCell.builder().text(invoiceLine.posnr).borderWidth(1).horizontalAlignment(RIGHT).build())
                    .add(TextCell.builder().text(invoiceLine.description).borderWidth(1).horizontalAlignment(LEFT).build())
                    .add(TextCell.builder().text(invoiceLine.amount).borderWidth(1).horizontalAlignment(RIGHT).build())
        ...
        if (discount != 0) {
            tableBuilder.addRow(Row.builder()
                    .add(TextCell.builder()
                            ...
                            .borderWidth(1)
                            .build())
                    .add(TextCell.builder().text(formatDouble(discount) + " %").backgroundColor(LIGHT_GRAY)
        ...
        tableBuilder.addRow(Row.builder()
                .add(TextCell.builder()
                        ...
                        .borderWidth(1)
                        .build())
                .add(TextCell.builder().text(formatDouble(grandTotal - (grandTotal * (discount / 100))) + " €")
