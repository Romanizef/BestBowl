...
public class DrinkPanel extends HorizontalLayout {
    ...
    public DrinkPanel(Drink drink) {
        ...
        FormLayout variantenLayout = new FormLayout();
        variantenLayout.setResponsiveSteps(new ResponsiveStep("200px", 3));
        ...
        for (DrinkVariant drinkVariant : drinkVariantList) {
            variantenLayout.add(createIntegerField(drinkVariant));
        }

        setWidthFull();
        addCSS();
        setAlignItems(Alignment.CENTER);
        add(label, variantenLayout);
    }
